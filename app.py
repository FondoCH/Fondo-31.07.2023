...
class Student(db.Model):
    ...
    def __init__(self, name, maths, sci, school, remarks,age, gender): #, total, mean):
        self.name = name
        self.maths = maths
        self.sci = sci
        self.school = school
        ...
        #self.total = self.maths + self.sci
        #self.mean = (self.maths + self.sci)/3
...
def show_all():
    ...
    return render_template('show_all.html', students=students, student=None)
...
def new():
    if request.method == 'POST':
        if not request.form['name'] or not request.form['maths'] or not request.form['sci']:
            ...
            student = Student(request.form['name'], request.form['maths'], request.form['sci'], request.form['school'], request.form['remarks'], request.form['age'], request.form['gender'])
...
def edit(id):
    ...
    if request.method == 'POST':
        ...
        #student.total = request.form['total']
        #student.mean = request.form['mean']
